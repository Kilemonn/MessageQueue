...
@Testcontainers
@ContextConfiguration(initializers = [RedisSentinelAuthenticatorTest.Initializer::class])
...
class RedisSentinelAuthenticatorTest: MultiQueueAuthenticatorTest()
{
    companion object
    {
    ...
    /**
     * The test initialiser for [RedisSentinelAuthenticatorTest] to initialise the container and test properties.
     *
     * @author github.com/Kilemonn
     */
