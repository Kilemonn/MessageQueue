...
@ContextConfiguration(initializers = [MongoAuthenticatorTest.Initializer::class])
...
class MongoAuthenticatorTest: MultiQueueAuthenticatorTest()
{
    companion object
    {
    ...
    /**
     * The test initialiser for [MongoAuthenticatorTest] to initialise the container and test properties.
     *
     * @author github.com/Kilemonn
     */
