 ...
 */
class MessageUpdateException(uuid: String) : Exception("Unable to update message with UUID [$uuid] as it either does not exist (and cannot be udpated) or there was an underlying error in the storage mechanism.")
